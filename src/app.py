...
activities = {
    ...
    "Drama Club": {
        ...
        "schedule": "Thursdays, 4:00 PM - 6:30 PM; rehearsal weekends as needed",
        "max_participants": 25,
        "participants": ["ava@mergington.edu", "ethan@mergington.edu"]
    },
    "Debate Team": {
        "description": "Prepare for local and regional debate tournaments; develop public speaking and argumentation skills",
        "schedule": "Tuesdays, 4:00 PM - 5:30 PM; Saturdays for practice debates",
        "max_participants": 20,
        "participants": ["lily@mergington.edu", "omar@mergington.edu"]
    },
    "Science Club": {
        "description": "Hands-on experiments, STEM projects, and participation in science fairs",
